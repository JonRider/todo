// Pull up data from local storage on start or start empty data
...
function addItem(value) {
    ...
    // Push data to data file
    data.todo.push(value);
    dataObjectUpdated();
}

// Render todo list from local storage data on restart
...
function removeItem() {
    ...
    if (id === 'todo') {
        // Remove item from todo data array
        data.todo.splice(data.todo.indexOf(value), 1);
    }
    else {
        // Remove item from completed data array
...
function completeItem() {
    ...
    if (id === 'todo') {
        // Remove item from todo data array and add to completed data array
        data.todo.splice(data.todo.indexOf(value), 1);
